...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bestaffiliate.link', // 网站地址
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-0Q0KM6MTDY', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Discover software affiliate programs to boost your income.', // 站点描述，被notion中的页面描述覆盖
